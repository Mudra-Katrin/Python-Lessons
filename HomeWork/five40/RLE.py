...
# Выходные данные:
# 6A1F2D7C1A17E
# (5 - количество единиц, далее сама единица, 4 - количество двоек, далее сам
# двойка и т.д)
...
print(f'Выходные данные:{encode(text)}')
print(f'Востановленные Входные данные:{decode(encode_text)}')        